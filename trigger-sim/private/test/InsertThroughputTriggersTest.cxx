...
TEST(test_default){
 ...
 I3Trigger t;
  ...
  double trigger_length_expectation = t.GetTriggerLength() +
    roConfig.readoutTimeMinus +
    roConfig.readoutTimePlus +
    roConfig.readoutTimeOffset;
  ENSURE_DISTANCE(ttrigger.GetTriggerLength(), trigger_length_expectation, 1e-4);
